...
describe("Test Contact Us form via WebdriverUni", () => {
    ...
    beforeEach(() => {
        cy.visit(Cypress.env("webdriveruni_homepage") + "/Contact-Us/contactus.html")  // используем название переменной, которую установили в конфиге. Их может быть несколько, подставлять можно любую
    })
